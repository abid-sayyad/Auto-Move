...
//  TWBR = 12;  // 400 kbit/sec I2C speed
  ...
  Serial.print("AK8963");
  Serial.print("ASAX ");Serial.print(magCalibration[0], 2);
  Serial.print("ASAY "); Serial.print(magCalibration[1], 2);
  Serial.print("ASAZ ");Serial.print(magCalibration[2], 2);
  delay(1000);  
  }
  else
  {
